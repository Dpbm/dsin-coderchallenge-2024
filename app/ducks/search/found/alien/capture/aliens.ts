...
const aliens: Alien[] = [
	{
		...
		attacks: {
			group: {
				distant:
					'Zerkans em grupo representam um grande problema para você. No entanto, nada que uma bomba de gás lacrimogênio seguido de um banho de chantili não os detenha.',
			...
			alone: {
				distant:
					'Não é comum ver um Zerkan sozinho, você está com sorte, antes de captura-lo use seu lançador de essência de baunilha para deixá-lo atordoado.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Um grupo de Maxinays não são dos seus maiores à distância. Assim, basta utilizar seu propulsor criando um enorme terremoto que os atordoarão.',
			...
			alone: {
				distant:
					'Estando distante, você possui a vantagem perante este Maxinay. Com seu propulsor teleguiado, mire diretamente nos pés dele, ao atingi-lo, o barulho e o tremor o atordoará.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Poroks são difíceis de serem vistos em grupo, primeiramente tire uma foto e poste no instagram, você pode ficar famoso. Após isso, você pode usar sua arma secreta, um grupo de vovós animadas para alimentar pequenas aves, eles não conseguiram resistir a isso.',
			...
			alone: {
				distant:
					'Estando sozinho e distante, atire um pão francês em sua cabeça. Ele ficará perdido num primeiro momento, mas logo verá o pão e estará muito ocupado saboreando um delicioso cacetinho.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Malgaths em conjunto podem se comunicar telepaticamente entre si e compartilharem seus sentidos aguçados. Sendo assim, a distância não será um ponto chave pra você. Contudo, você pode usar o perfume Ferrari 1973 turbo V8 que atrapalham seus sentidos e fazem eles desmaiarem.',
			...
			alone: {
				distant:
					'Um Malgath estando sozinho e distante de você, seus sentidos perdem força, e não será possível usar seu perfume secreto a distância. Sendo assim, use o para-glide presente na sua mochila para se aproximar e então passe seu perfume Ferrar 1974 turbo V8, atordoando-o.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Zarqon é um ser muito inteligente, contudo um nerd por natureza. Para derrotar um grupo deles a distância, hackeie o telão mais próximo do grupo e transmita o episódio 15 da primeira temporada de Star Trek, isso manterá eles completamente hipnotizados.',
			...
			alone: {
				distant:
					'Um Zarqon sozinho é fácil de ser derrotado a distância usando suas habilidades. Para isso, hackeie o celular dele, e toque mude o toque de chamada para o tema de Star Trek. Após fazer isso, ligue para o seu inimigo e veja-o ficando hipnotizado por essa maravilha sonora.',
	...
	},
	{
		...
		attacks: {
			...
			alone: {
				distant:
					'Ao avistar um Vyrra solitário, utilize seu gancho com uma cortina blackout na ponta para agarrar o ser. Dessa forma, caso esteja de dia, ele não conseguirá energia, e caso contrário você terá um chance de capturá-lo.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Se você encontrar um grupo distante de Kruvals, você tem uma baita sorte, esses são os bichos mais fracos que você poderia encontrar. Um simples jato de água os deterá.',
			...
			alone: {
				distant:
					"Para deter um único Kruval a distância, é possível utilizar um balão d'água, sendo atirado diretamente em seu rosto.",
	...
	},
	{
		...
		attacks: {
			...
			alone: {
				distant:
					'Aproxime-se ao máximo dele, e em seguida esgueire pode de baixo e pressione o botão presente em meio aos seus tentáculos. Fazendo isso, ele entrará em modo promiscuo dando uma chance de você o capturar.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Lygor é um ser do mar. Para derrotar um grupo deles, atire terra/arreia usando seu lança coisas presente em sua mochila tática. Ao fazer isso, seus movimentos ficarão limitados, dando uma chance de você os capturar.',
			...
			alone: {
				distant:
					'Um lygor solitário a distância pode, pode ser facilmente derrotado com um balde de arreia. Arremesse o balde sobre ele, e você conseguirá imobilizá-lo.',
	...
	},
	{
		...
		attacks: {
			group: {
				distant:
					'Para derrotar um grupo de purple tentacles, crie um jornal falso dizendo que o Purple Tentacle #45 é o melhor. Eles ficarão extremamente revoltados e atacarão o de número 45. Após a intensa briga entre eles, você poderá sem problemas se aproximar para tentar realizar a captura.',
			...
			alone: {
				distant:
					'Estando distante de um único Purple tentacle, grite escondido "Green Tentacle é muito melhor!!!". Com isso, o Purple Tentacle desmaiará de raiva, e você tentar capturá-lo.',
...
const situations: Situation[] = [
	...
	{
		story: 'No seu caminho para casa, seu vizinho lhe cumprimenta e diz que está muito feliz por ter adotado um novo pet. Seu sonho sempre foi ter uma avé e patos são fofos, então por que não um pet? Assim seu vizinho o pega no colo aproxima-o de você. Tudo parecia normal, no entanto, seu óculo high-tech não mente, é um alien, não qualquer alien, mas na verdade',
		group: false,
		distant: false,
	},
];
